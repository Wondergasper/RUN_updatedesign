          ...
          <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
            ...
            <form method="POST" action="changepass.php">     
              ...
              <div class="form-outline mb-4">
                <input type="uname" placeholder="" name="uname" id="uname" required="" class="form-control form-control-lg" />
              ...
              <!-- Submit button -->
              <button type="submit" value="Submit" class="btn btn-primary btn-lg btn-block">Change Password</button>
